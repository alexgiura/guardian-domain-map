...
interface TopBarProps {
  activeTab: "dashboard" | "domains" | "import" | "traffic" | "watchlist";
  onTabChange: (tab: "dashboard" | "domains" | "import" | "traffic" | "watchlist") => void;
  username?: string;
  onLogout?: () => void;
}

const TopBar = ({ activeTab, onTabChange, username, onLogout }: TopBarProps) => {
  const tabs: { key: "dashboard" | "domains" | "import" | "traffic" | "watchlist"; label: string }[] = [
